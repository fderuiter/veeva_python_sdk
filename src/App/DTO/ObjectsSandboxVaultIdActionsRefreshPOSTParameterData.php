...
/**
 * Parameters for objectsSandboxVaultIdActionsRefreshPOST
 */
class ObjectsSandboxVaultIdActionsRefreshPOSTParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="vault_id")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $vault_id = null;
