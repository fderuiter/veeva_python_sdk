...
/**
 * Parameters for metadataObjectsDocumentsAnnotationsReferencesTypesReferenceTypeGET
 */
class MetadataObjectsDocumentsAnnotationsReferencesTypesReferenceTypeGETParameterData
{
    /**
    ...
    /**
     * @DTA\Data(subset="path", field="reference_type")
