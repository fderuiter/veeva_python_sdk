...
/**
 * Parameters for objectsObjectworkflowsWorkflowIdActionsWorkflowActionGET
 */
class ObjectsObjectworkflowsWorkflowIdActionsWorkflowActionGETParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="workflow_id")
     ...
     * @DTA\Data(subset="path", field="workflow_action")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $workflow_action = null;
