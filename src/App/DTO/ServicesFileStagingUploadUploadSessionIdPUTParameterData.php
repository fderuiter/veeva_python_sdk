...
/**
 * Parameters for servicesFileStagingUploadUploadSessionIdPUT
 */
class ServicesFileStagingUploadUploadSessionIdPUTParameterData
{
    /**
     ...
     * @DTA\Data(subset="header", field="X-VaultAPI-FilePartNumber", nullable=true)
     * @DTA\Strategy(subset="header", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="header", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $x_vault_api_file_part_number = null;
     ...
     * @DTA\Data(subset="header", field="Content-MD5", nullable=true)
     * @DTA\Strategy(subset="header", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="header", name="QueryStringScalar", options={"type":"string"})
     */
