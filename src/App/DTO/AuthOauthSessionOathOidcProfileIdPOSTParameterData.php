...
/**
 * Parameters for authOauthSessionOathOidcProfileIdPOST
 */
class AuthOauthSessionOathOidcProfileIdPOSTParameterData
{
    /**
    ...
    /**
     * @DTA\Data(subset="path", field="oath_oidc_profile_id")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $oath_oidc_profile_id = null;
