...
/**
 * Parameters for metadataObjectsDocumentsEventsEventTypeTypesEventSubtypeGET
 */
class MetadataObjectsDocumentsEventsEventTypeTypesEventSubtypeGETParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="event_type")
     ...
     * @DTA\Data(subset="path", field="event_subtype")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
