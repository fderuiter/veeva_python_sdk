...
/**
 * Parameters for metadataObjectsDocumentsTypesTypeSubtypesSubtypeClassificationsClassificationGET
 */
class MetadataObjectsDocumentsTypesTypeSubtypesSubtypeClassificationsClassificationGETParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="subtype")
     ...
     * @DTA\Data(subset="path", field="classification")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
