...
/**
 * Parameters for metadataQueryDocumentsRelationshipsDocumentSignatureSysrGET
 */
class MetadataQueryDocumentsRelationshipsDocumentSignatureSysrGETParameterData
{
    /**
