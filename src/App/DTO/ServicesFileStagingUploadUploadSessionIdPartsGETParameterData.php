...
/**
 * Parameters for servicesFileStagingUploadUploadSessionIdPartsGET
 */
class ServicesFileStagingUploadUploadSessionIdPartsGETParameterData
{
    /**
    ...
    /**
     * @DTA\Data(subset="path", field="upload_session_id")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $upload_session_id = null;
