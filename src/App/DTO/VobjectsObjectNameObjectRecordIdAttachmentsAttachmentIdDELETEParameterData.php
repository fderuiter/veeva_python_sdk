...
/**
 * Parameters for vobjectsObjectNameObjectRecordIdAttachmentsAttachmentIdDELETE
 */
class VobjectsObjectNameObjectRecordIdAttachmentsAttachmentIdDELETEParameterData
{
    /**
