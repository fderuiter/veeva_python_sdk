...
/**
 * Parameters for vobjectsObjectNameObjectRecordIdAttachmentsAttachmentIdVersionsAttachmentVersionPOST
 */
class VobjectsObjectNameObjectRecordIdAttachmentsAttachmentIdVersionsAttachmentVersionPOSTParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="attachment_version")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $attachment_version = null;

    /**
     * @DTA\Data(subset="query", field="restore", nullable=true)
     ...
     * @DTA\Data(subset="path", field="attachment_id")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
