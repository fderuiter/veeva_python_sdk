...
/**
 * Parameters for objectsDocumentsBatchActionsFileextractPOST
 */
class ObjectsDocumentsBatchActionsFileextractPOSTParameterData
{
    /**
     ...
     * @DTA\Data(subset="query", field="renditions", nullable=true)
     ...
     * @DTA\Data(subset="query", field="allversions", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"bool"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"bool"})
     */
