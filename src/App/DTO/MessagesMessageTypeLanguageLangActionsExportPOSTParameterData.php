...
/**
 * Parameters for messagesMessageTypeLanguageLangActionsExportPOST
 */
class MessagesMessageTypeLanguageLangActionsExportPOSTParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="lang")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
