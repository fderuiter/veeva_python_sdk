...
/**
 * Parameters for compositesTreesEdlHierarchyOrTemplateActionsListnodesPOST
 */
class CompositesTreesEdlHierarchyOrTemplateActionsListnodesPOSTParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="edl_hierarchy_or_template")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $edl_hierarchy_or_template = null;
