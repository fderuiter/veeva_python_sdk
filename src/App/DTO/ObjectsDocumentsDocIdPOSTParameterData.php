...
/**
 * Parameters for objectsDocumentsDocIdPOST
 */
class ObjectsDocumentsDocIdPOSTParameterData
{
    /**
     ...
     * @DTA\Data(subset="query", field="suppressRendition", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $suppress_rendition = null;
