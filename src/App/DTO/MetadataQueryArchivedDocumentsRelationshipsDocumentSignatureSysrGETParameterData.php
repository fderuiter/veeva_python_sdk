...
/**
 * Parameters for metadataQueryArchivedDocumentsRelationshipsDocumentSignatureSysrGET
 */
class MetadataQueryArchivedDocumentsRelationshipsDocumentSignatureSysrGETParameterData
{
    /**
