...
/**
 * Parameters for objectsBindersBinderIdDocumentsNodeIdBindingRulePUT
 */
class ObjectsBindersBinderIdDocumentsNodeIdBindingRulePUTParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="node_id")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
