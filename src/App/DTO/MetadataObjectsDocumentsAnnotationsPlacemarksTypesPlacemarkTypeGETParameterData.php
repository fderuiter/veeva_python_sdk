...
/**
 * Parameters for metadataObjectsDocumentsAnnotationsPlacemarksTypesPlacemarkTypeGET
 */
class MetadataObjectsDocumentsAnnotationsPlacemarksTypesPlacemarkTypeGETParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="placemark_type")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $placemark_type = null;
