...
/**
 * Parameters for servicesVobjectVaultPackageVPackageIdActionsValidatePOST
 */
class ServicesVobjectVaultPackageVPackageIdActionsValidatePOSTParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="package_id")
