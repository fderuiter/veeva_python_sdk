...
additionalProperties:
  packageGuid: '{6FA6E359-70A6-48E2-9EF4-89A75566159B}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IApiGetApiResponse apiResponse = await api.ApiGetAsync("todo");
...
## Api Information
- appName: Veeva Vault API v25.1
- appVersion: 1.0.0
- appDescription: The latest GA version of the Vault REST API.
