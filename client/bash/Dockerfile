...
# Setup prompt
#
RUN echo 'export PS1="[Veeva Vault API v25.1] \$ "' >> ~/.bashrc
RUN echo 'export PROMPT="[Veeva Vault API v25.1] \$ "' >> ~/.zshrc
...
line REST client for $(tput setaf 6)Veeva Vault API v25.1$(tput sgr0).\n\
\n\
