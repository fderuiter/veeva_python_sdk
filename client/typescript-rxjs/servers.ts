...
const server1 = new ServerConfiguration<{  "version": string  }>("{{vaultDNS}}/api/{version}", {  "version": "v25.1"  }, "");
const server2 = new ServerConfiguration<{  "version": string  }>("login.veevavault.com/api/{version}", {  "version": "v25.1"  }, "");
