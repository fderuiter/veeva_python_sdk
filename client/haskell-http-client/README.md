## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Veeva Vault API v25.1`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Veeva Vault API v25.1 API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | VeevaVaultAPIV25.1                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | veeva-vault-api-v25.1                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | 1Config                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | 1Request                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| VeevaVaultAPIV25.1.Client    | use the "dispatch" functions to send requests       |
| VeevaVaultAPIV25.1.Core      | core functions, config and request types            |
| VeevaVaultAPIV25.1.API       | construct api requests                              |
| VeevaVaultAPIV25.1.Model     | describes api models                                |
| VeevaVaultAPIV25.1.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| VeevaVaultAPIV25.1.ModelLens | lenses for model fields                             |
| VeevaVaultAPIV25.1.Logging   | logging functions and utils                         |
