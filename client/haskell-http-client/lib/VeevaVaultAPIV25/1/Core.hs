...
module VeevaVaultAPIV25.1.Core where
...
-- configUserAgent:
--
-- @"veeva-vault-api-v25.1/0.1.0.0"@
--
newConfig :: IO 1Config
newConfig = do
    logCxt <- initLogContext
    return $ 1Config
        { configHost = "http://}/api/v25.1"
        , configUserAgent = "veeva-vault-api-v25.1/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => 1Config -> auth -> 1Config
addAuthMethod config@1Config {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: 1Config -> IO 1Config
...
withStderrLogging :: 1Config -> IO 1Config
...
data 1Request req contentType res accept = 1Request
  { rMethod  :: NH.Method   -- ^ Method of 1Request
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of 1Request
  , rParams   :: Params -- ^ params of 1Request
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (1Request req contentType res accept) NH.Method
rMethodL f 1Request{..} = (\rMethod -> 1Request { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (1Request req contentType res accept) [BCL.ByteString]
rUrlPathL f 1Request{..} = (\rUrlPath -> 1Request { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (1Request req contentType res accept) Params
rParamsL f 1Request{..} = (\rParams -> 1Request { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (1Request req contentType res accept) [P.TypeRep]
rAuthTypesL f 1Request{..} = (\rAuthTypes -> 1Request { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => 1Request req contentType res accept -> param -> 1Request req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: 1Request req contentType res accept -> param -> 1Request req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: 1Request req contentType res accept -> param -> 1Request req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
_mkRequest :: NH.Method -- ^ Method
          ...
          -> 1Request req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = 1Request m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     1Request req contentType res accept
  -> [NH.Header]
  -> 1Request req contentType res accept
...
removeHeader :: 1Request req contentType res accept -> [NH.HeaderName] -> 1Request req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => 1Request req contentType res accept -> 1Request req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => 1Request req contentType res accept -> 1Request req contentType res accept
...
addForm :: 1Request req contentType res accept -> WH.Form -> 1Request req contentType res accept
addForm req newform =
...
_addMultiFormPart :: 1Request req contentType res accept -> NH.Part -> 1Request req contentType res accept
...
_setBodyBS :: 1Request req contentType res accept -> B.ByteString -> 1Request req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: 1Request req contentType res accept -> BL.ByteString -> 1Request req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => 1Request req contentType res accept -> P.Proxy authMethod -> 1Request req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> 1Request req contentType res accept
    -> IO (1Request req contentType res accept)
...
_applyAuthMethods
  ...
  -> 1Config
  -> IO (1Request req contentType res accept)
_applyAuthMethods req config@(1Config {configAuthMethods = as}) =
  foldlM go req as
  where
