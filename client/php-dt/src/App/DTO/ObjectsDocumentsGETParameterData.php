...
/**
 * Parameters for objectsDocumentsGET
 */
class ObjectsDocumentsGETParameterData
{
    /**
     ...
     * @DTA\Data(subset="query", field="scope", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
     ...
     * @DTA\Data(subset="query", field="versionscope", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
     ...
     * @DTA\Data(subset="query", field="named_filter", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $named_filter = null;
