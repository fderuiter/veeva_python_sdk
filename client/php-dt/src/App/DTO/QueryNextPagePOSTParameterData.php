...
/**
 * Parameters for queryNextPagePOST
 */
class QueryNextPagePOSTParameterData
{
    /**
     * @DTA\Data(subset="path", field="next_page")
    ...
    /**
     * @DTA\Data(subset="header", field="X-VaultAPI-DescribeQuery", nullable=true)
     ...
     */
    public ?bool $x_vault_api_describe_query = null;
