...
/**
 * Parameters for objectsDocumentsLifecycleActionsUserActionNamePUT
 */
class ObjectsDocumentsLifecycleActionsUserActionNamePUTParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="user_action_name")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $user_action_name = null;
