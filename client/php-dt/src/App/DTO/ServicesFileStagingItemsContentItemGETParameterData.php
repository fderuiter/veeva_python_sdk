...
/**
 * Parameters for servicesFileStagingItemsContentItemGET
 */
class ServicesFileStagingItemsContentItemGETParameterData
{
    /**
     ...
     * @DTA\Data(subset="header", field="Range", nullable=true)
     * @DTA\Strategy(subset="header", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="header", name="QueryStringScalar", options={"type":"string"})
     */
