...
/**
 * Parameters for objectsDocumentsDocIdVersionsMajorVersionMinorVersionRelationshipsRelationshipIdDELETE
 */
class ObjectsDocumentsDocIdVersionsMajorVersionMinorVersionRelationshipsRelationshipIdDELETEParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="relationship_id")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
