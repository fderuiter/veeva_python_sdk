...
/**
 * Parameters for compositesTreesEdlHierarchyVParentNodeIdChildrenGET
 */
class CompositesTreesEdlHierarchyVParentNodeIdChildrenGETParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="parent_node_id")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $parent_node_id = null;
