...
/**
 * Parameters for vobjectsObjectNameObjectRecordIdAttachmentFieldsAttachmentFieldNameFilePOST
 */
class VobjectsObjectNameObjectRecordIdAttachmentFieldsAttachmentFieldNameFilePOSTParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="attachment_field_name")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $attachment_field_name = null;
