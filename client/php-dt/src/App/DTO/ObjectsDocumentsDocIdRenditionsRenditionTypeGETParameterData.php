...
/**
 * Parameters for objectsDocumentsDocIdRenditionsRenditionTypeGET
 */
class ObjectsDocumentsDocIdRenditionsRenditionTypeGETParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="rendition_type")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $rendition_type = null;
     ...
     * @DTA\Data(subset="query", field="steadyState", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $steady_state = null;
