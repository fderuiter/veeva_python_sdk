...
/**
 * Parameters for vobjectsObjectNameObjectRecordIdActionsActionNamePOST
 */
class VobjectsObjectNameObjectRecordIdActionsActionNamePOSTParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="action_name")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
