...
/**
 * Parameters for servicesQueuesQueueNameActionsDisableDeliveryPUT
 */
class ServicesQueuesQueueNameActionsDisableDeliveryPUTParameterData
{
    /**
     * The name of a specific Queue.
     * @DTA\Data(subset="path", field="queue_name")
