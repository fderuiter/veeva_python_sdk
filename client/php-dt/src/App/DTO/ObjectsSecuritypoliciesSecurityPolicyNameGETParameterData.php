...
/**
 * Parameters for objectsSecuritypoliciesSecurityPolicyNameGET
 */
class ObjectsSecuritypoliciesSecurityPolicyNameGETParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="security_policy_name")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $security_policy_name = null;
