...
/**
 * Parameters for objectsGroupsGET
 */
class ObjectsGroupsGETParameterData
{
    /**
     ...
     * @DTA\Data(subset="query", field="includeImplied", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $include_implied = null;
