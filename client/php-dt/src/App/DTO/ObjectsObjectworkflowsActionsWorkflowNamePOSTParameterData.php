...
/**
 * Parameters for objectsObjectworkflowsActionsWorkflowNamePOST
 */
class ObjectsObjectworkflowsActionsWorkflowNamePOSTParameterData
{
    /**
    ...
    /**
     * @DTA\Data(subset="path", field="workflow_name")
