...
/**
 * Parameters for objectsBindersTemplatesTemplateNameBindernodesPOST
 */
class ObjectsBindersTemplatesTemplateNameBindernodesPOSTParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="template_name")
