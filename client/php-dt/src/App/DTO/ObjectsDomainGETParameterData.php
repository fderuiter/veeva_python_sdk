...
/**
 * Parameters for objectsDomainGET
 */
class ObjectsDomainGETParameterData
{
    /**
     ...
     * @DTA\Data(subset="query", field="include_application", nullable=true)
     ...
     */
    public ?bool $include_application = null;
