...
/**
 * Parameters for vobjectsObjectNameObjectRecordIdAttachmentsAttachmentIdGET
 */
class VobjectsObjectNameObjectRecordIdAttachmentsAttachmentIdGETParameterData
{
    /**
