...
/**
 * Parameters for logsCodeRuntimeGET
 */
class LogsCodeRuntimeGETParameterData
{
    /**
     * @DTA\Data(subset="query", field="date", nullable=true)
     ...
     * @DTA\Data(subset="query", field="log_format", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
