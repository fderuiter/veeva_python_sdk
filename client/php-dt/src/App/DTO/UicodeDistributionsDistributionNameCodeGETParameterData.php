...
/**
 * Parameters for uicodeDistributionsDistributionNameCodeGET
 */
class UicodeDistributionsDistributionNameCodeGETParameterData
{
    /**
     * The name attribute of the client code distribution to download.
     * @DTA\Data(subset="path", field="distribution_name")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $distribution_name = null;
