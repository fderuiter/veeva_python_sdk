...
/**
 * Parameters for configurationObjectNameAndObjectTypeGET
 */
class ConfigurationObjectNameAndObjectTypeGETParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="object_name_and_object_type")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $object_name_and_object_type = null;
