...
/**
 * Parameters for metadataVobjectsObjectNameFieldsObjectFieldNameGET
 */
class MetadataVobjectsObjectNameFieldsObjectFieldNameGETParameterData
{
    /**
     * The object field name value (id, name__v, external_id__v, etc.).
     * @DTA\Data(subset="path", field="object_field_name")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $object_field_name = null;
