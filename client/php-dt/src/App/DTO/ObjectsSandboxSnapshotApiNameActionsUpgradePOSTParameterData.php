...
/**
 * Parameters for objectsSandboxSnapshotApiNameActionsUpgradePOST
 */
class ObjectsSandboxSnapshotApiNameActionsUpgradePOSTParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="api_name")
