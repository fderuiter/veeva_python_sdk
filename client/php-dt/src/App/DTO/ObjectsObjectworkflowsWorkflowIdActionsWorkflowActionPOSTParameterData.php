...
/**
 * Parameters for objectsObjectworkflowsWorkflowIdActionsWorkflowActionPOST
 */
class ObjectsObjectworkflowsWorkflowIdActionsWorkflowActionPOSTParameterData
{
    /**
     ...
     * @DTA\Data(subset="query", field="documents__sys", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $documents__sys = null;
