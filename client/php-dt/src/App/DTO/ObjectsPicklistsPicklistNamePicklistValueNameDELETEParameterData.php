...
/**
 * Parameters for objectsPicklistsPicklistNamePicklistValueNameDELETE
 */
class ObjectsPicklistsPicklistNamePicklistValueNameDELETEParameterData
{
    /**
     ...
     * @DTA\Data(subset="path", field="picklist_name")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $picklist_name = null;
     ...
     * @DTA\Data(subset="path", field="picklist_value_name")
     * @DTA\Strategy(subset="path", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="path", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $picklist_value_name = null;
