...
defmodule VeevaVaultAPIV251.Connection do
  @moduledoc """
  Handle Tesla connections for VeevaVaultAPIV251.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, VeevaVaultAPIV251.Connection,
        base_url: "http://}/api/v25.1",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :veeva_vault_apiv251,
        :base_url, "http://}/api/v25.1"
  """
  ...
  @doc """
  Configure a VeevaVaultAPIV251 client.

  ### Parameters

  - `options`: an optional keyword list of VeevaVaultAPIV251.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:veeva_vault_apiv251, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - VeevaVaultAPIV251 1.0.0 - elixir"
        )
      )
